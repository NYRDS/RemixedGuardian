...
def makeGameMaster():
    baseDef = (
        ...
        + """
Беспристрастный гейм мастер, ведущий ролевую игру, следит за соблюдением сеттинга, а также тщательно отслеживает любые изменения в состоянии игроков, npc и их окружения. 
        """
    )
