...
Содержит ли текст {player} только реплики и действия {player} (реплика не должна описывать действия других персонажей)? 
...
Может ли {player} осуществить эти действия, обрати внимание на его статус и описание?
Жкв лм {player}? Мертвые не могут ничего сделать или сказать.

Если ответ на все вопросы да, ответь только одним словом да, иначе язвительно и саркастично объясни почему реплика {player} некорректна.  
"""
