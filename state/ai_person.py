...
Содержит ли текст {player} только реплики и действия {player}? Реплика {player} не должна описывать действия других персонажей, но может описывать реплики, просьбы или приказы обращенные к другим персонажам 
...
Может ли {player} осуществить эти действия в текущем состоянии (обрати внимание на его статус)?
...
Лист персонажа должен быть кратким, не более 200 слов, но не теряй важные детали!
