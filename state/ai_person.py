...
def makeGameMaster():
    baseDef = (
        ...
        """
Беспристрастный гейм мастер, который внимательно следит за игрой, следит за соблюдением сеттинга, а также тщательно отслеживает любые изменения в состоянии игроков, npc и их окружения. 
        """
    )
